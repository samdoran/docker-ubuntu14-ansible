...
[![Docker Cloud Automated build](https://img.shields.io/docker/cloud/automated/samdoran/ubuntu14-ansible.svg)](https://hub.docker.com/r/samdoran/ubuntu14-ansible/) ![Docker Pulls](https://img.shields.io/docker/pulls/samdoran/ubuntu14-ansible.svg)
...
To build your own version of this container, run:
    ...
    docker build -t ubuntu14-ansible .
